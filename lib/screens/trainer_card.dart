...
class _TrainerCardPageState extends State<TrainerCardPage> {
  ...
  final List<IconData> _badges = [
    ...
    Icons.bolt, Icons.water_drop, Icons.grass, 

    Icons.psychology, Icons.favorite, Icons.change_history, 

    Icons.hexagon, Icons.local_fire_department
...
class TrainerCardDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // 'Press Start 2P' is wider and more "8-bit" but thinner strokes than bold VT323
    ...
    final pixelStyle = GoogleFonts.pressStart2p(
      ...
      height: 1.4, // Needs more line height as it's blocky
    ...
    const Color borderLight = Color(0xFF63c7c8); // Light Cyan

    const Color borderDark = Color(0xFF286a6b);  // Dark Teal

    const Color cardBgLight = Color(0xFF86c096); // Light Sage

    const Color cardBgDark = Color(0xFF6aa87b);  // Dark Sage (for stripes)
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: Colors.white, width: 2), // Outer white rim
      ...
      padding: const EdgeInsets.all(6), // Space for the light border
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                const SizedBox(height: 48), // Adjusted for new font
            ...
            // 3. GLOBAL STRIPES (Drawn over backgrounds, under content)
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: borderDark, width: 2), // Inner dark border
                      ...
                      child: Align(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: const Color(0xFF70a0e0), // Retro Blue
                          ...
                          Expanded(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text("DEBUT DATE: $debutDate", style: pixelStyle), // Same size

                                const SizedBox(height: 6),

                                Text("STREAK: $streak DAYS", style: pixelStyle), // Same size
